...
export default function LocationCard({ id, City, Longitude, Latitude,day, choosefilename , Get_Resolve}) {
  ...
  return (
    <Card sx={{ maxWidth: 345, backgroundColor: "lightgrey" }}>
      ...
      <CardActions disableSpacing>
        <ColorButton variant="contained" onClick={()=>{Get_Resolve(id,City, Longitude, Latitude,day)}}>Resolve</ColorButton>
        <ExpandMore
          expand={expanded}
